...
function userLoadLists() {
	...
	function loadList(l) {
		...
		//HTML title tag
		document.title = `${varPageTitle} | ${pageTitleMeta}`;
		//header changes
...
function homePage() {
	//HTML title tag
	document.title = `Home | ${pageTitleMeta}`;
	//Page Description
...
function signUpPage() {
	//HTML title tag
	document.title = `Sign Up | ${pageTitleMeta}`;
	//Page Description
...
function logInPage() {
	//HTML title tag
	document.title = `Log In | ${pageTitleMeta}`;
	//Page Description
...
function dashboardPage() {
	//HTML title tag
	document.title = `Dashboard | ${pageTitleMeta}`;
	//variables
...
function newListPage() {
	//HTML title tag
	document.title = `New List | ${pageTitleMeta}`;
	//header changes
...
function userAccountSettings() {
	//HTML title tag
	document.title = `Account Settings | ${pageTitleMeta}`;
	//header changes
